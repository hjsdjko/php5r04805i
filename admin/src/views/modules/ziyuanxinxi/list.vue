		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="资源状态" prop="ziyuanzhuangtai">
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">资源状态</label>
						<el-select clearable v-model="searchForm.ziyuanzhuangtai" placeholder="请选择资源状态" >
							<el-option v-for="(item,index) in ziyuanzhuangtaiOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='false' :sortable='false'  
						prop="ziyuanzhuangtai"
						label="资源状态">
						<template slot-scope="scope">
							{{scope.row.ziyuanzhuangtai}}
						</template>
					</el-table-column>
					<el-table-column :resizable='false' :sortable='false'  
						prop="fabushijian"
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="edit" v-if=" isAuth('ziyuanxinxi','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
								<span class="icon iconfont " :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
								修改
							</el-button>
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
          ...
          if(this.searchForm.ziyuanzhuangtai!='' && this.searchForm.ziyuanzhuangtai!=undefined){
            params['ziyuanzhuangtai'] = this.searchForm.ziyuanzhuangtai
          }
