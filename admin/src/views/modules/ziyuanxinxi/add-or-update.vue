	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="资源状态" prop="ziyuanzhuangtai">
					<el-select :disabled="ro.ziyuanzhuangtai" v-model="ruleForm.ziyuanzhuangtai" placeholder="请选择资源状态" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="资源状态" prop="ziyuanzhuangtai">
					<el-input v-model="ruleForm.ziyuanzhuangtai"
						placeholder="资源状态" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="资源简介" prop="ziyuanjianjie">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.ziyuanjianjie" label="资源简介" prop="ziyuanjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.ziyuanjianjie}}</span>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.ziyuanzhuangtai = '可用'; 			}
			// 获取用户信息
			this.$http({
