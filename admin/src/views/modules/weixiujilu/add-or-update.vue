	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="故障情况" prop="guzhangqingkuang">
					<el-input v-model="ruleForm.guzhangqingkuang" placeholder="故障情况" clearable  :readonly="ro.guzhangqingkuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="故障情况" prop="guzhangqingkuang">
					<el-input v-model="ruleForm.guzhangqingkuang" placeholder="故障情况" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="损坏情况" prop="sunhuaiqingkuang">
					<el-input v-model="ruleForm.sunhuaiqingkuang" placeholder="损坏情况" clearable  :readonly="ro.sunhuaiqingkuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="损坏情况" prop="sunhuaiqingkuang">
					<el-input v-model="ruleForm.sunhuaiqingkuang" placeholder="损坏情况" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="报修时间" prop="baoxiushijian">
					<el-input v-model="ruleForm.baoxiushijian" placeholder="报修时间" clearable  :readonly="ro.baoxiushijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="报修时间" prop="baoxiushijian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="修复日期" prop="xiufuriqi">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.xiufuriqi" 
						type="datetime"
						:readonly="ro.xiufuriqi"
						placeholder="修复日期"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xiufuriqi" label="修复日期" prop="xiufuriqi">
					<el-input v-model="ruleForm.xiufuriqi" placeholder="修复日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="维修账号" prop="weixiuzhanghao">
					<el-input v-model="ruleForm.weixiuzhanghao" placeholder="维修账号" clearable  :readonly="ro.weixiuzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="维修账号" prop="weixiuzhanghao">
					<el-input v-model="ruleForm.weixiuzhanghao" placeholder="维修账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="维修姓名" prop="weixiuxingming">
					<el-input v-model="ruleForm.weixiuxingming" placeholder="维修姓名" clearable  :readonly="ro.weixiuxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="维修姓名" prop="weixiuxingming">
					<el-input v-model="ruleForm.weixiuxingming" placeholder="维修姓名" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="修复方式" prop="xiufufangshi">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="修复方式"
					  v-model="ruleForm.xiufufangshi" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xiufufangshi" label="修复方式" prop="xiufufangshi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.xiufufangshi}}</span>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.xiufuriqi = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='guzhangqingkuang'){
							this.ruleForm.guzhangqingkuang = obj[o];
							this.ro.guzhangqingkuang = true;
							continue;
						}
						...
						if(o=='xiufufangshi'){
							this.ruleForm.xiufufangshi = obj[o];
							this.ro.xiufufangshi = true;
							continue;
						}
						if(o=='xiufuriqi'){
							this.ruleForm.xiufuriqi = obj[o];
							this.ro.xiufuriqi = true;
							continue;
						}
						if(o=='weixiuzhanghao'){
