...
class ApiController extends CommonController
{
    ...
    public function download()
    {
        ...
        header('location:http://' . $_SERVER['HTTP_HOST'] . '/php5r04805i/upload/' . $fileName);
        exit; 
    }
    /**
     * 获取某表的某个字段列表接口
    ...
    public function group($tablesName,$columnName){
        ...
        if ($tokens['isAdmin']!=1 || ($tokens['isAdmin']==1 && $tokens['tablename'] != "users")){
            if($tokens['tablename'] == 'yuyueziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tokens['tablename'] == 'baoxiuziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tokens['tablename'] == 'guihaiziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tokens['tablename'] == 'genghuanziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tokens['tablename'] == 'weixiujilu'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tokens['tablename'] == 'quxiaojilu'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
    ...
    public function value($tableName,$xColumnName,$yColumnName,$tjType){
        ...
        $where = " where 1 ";
        if ($tokens['isAdmin']!=1 || ($tokens['isAdmin']==1 && $tokens['tablename'] != "users")){
            if($tableName == 'yuyueziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'baoxiuziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'guihaiziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'genghuanziyuan'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'weixiujilu'){
                if($tokens['tablename'] == 'yonghu'){
                    $where .= " and `yonghuzhanghao` = '".$tokens['username']."' ";
                }
            }
