<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231114/b02cac02c33549cda223ecdd28fe233a.png) fixed","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px 80px","boxShadow":"0px 0 2px #DFDFDF","margin":"110px 10% 110px 0","borderRadius":"10px","flexWrap":"wrap","background":"rgba(255,255,255,.8)","display":"flex","width":"650px","position":"relative","justifyContent":"flex-end","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#654B3C","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600"}'>多媒体教室管理系统注册</p></div>
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='weixiurenyuan'" prop="weixiuzhanghao">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('weixiuzhanghao')?'required':''">维修账号：</div>
				<el-input v-model="registerForm.weixiuzhanghao"  placeholder="请输入维修账号" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='weixiurenyuan'" prop="weixiuxingming">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('weixiuxingming')?'required':''">维修姓名：</div>
				<el-input v-model="registerForm.weixiuxingming"  placeholder="请输入维修姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='weixiurenyuan'" prop="mima">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('mima')?'required':''">密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='weixiurenyuan'" prop="mima2">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('mima')?'required':''">确认密码：</div>
				<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='weixiurenyuan'" prop="xingbie">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('xingbie')?'required':''">性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='weixiurenyuan'" prop="lianxifangshi">
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='weixiurenyuan'" prop="touxiang">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('touxiang')?'required':''">头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
          ...
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`yonghu` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
				...
				if((!this.registerForm.weixiuzhanghao) && `weixiurenyuan` == this.tableName){
					this.$message.error(`维修账号不能为空`);
					return
				}
				if((!this.registerForm.weixiuxingming) && `weixiurenyuan` == this.tableName){
               ...
               if(`weixiurenyuan` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
				...
				if((!this.registerForm.mima) && `weixiurenyuan` == this.tableName){
					...
					if(`weixiurenyuan` == this.tableName && this.registerForm.lianxifangshi &&(!this.$validate.isMobile2(this.registerForm.lianxifangshi))){
