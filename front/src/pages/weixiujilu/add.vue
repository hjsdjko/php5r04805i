...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="故障情况" prop="guzhangqingkuang">
            <el-input v-model="ruleForm.guzhangqingkuang" 
                placeholder="故障情况" clearable :disabled=" false  ||ro.guzhangqingkuang"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="损坏情况" prop="sunhuaiqingkuang">
            <el-input v-model="ruleForm.sunhuaiqingkuang" 
                placeholder="损坏情况" clearable :disabled=" false  ||ro.sunhuaiqingkuang"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="报修时间" prop="baoxiushijian">
            <el-input v-model="ruleForm.baoxiushijian" 
                placeholder="报修时间" clearable :disabled=" false  ||ro.baoxiushijian"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="修复日期" prop="xiufuriqi">
              <el-date-picker
				  :disabled=" false  ||ro.xiufuriqi"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="维修账号" prop="weixiuzhanghao">
            <el-input v-model="ruleForm.weixiuzhanghao" 
                placeholder="维修账号" clearable :disabled=" false  ||ro.weixiuzhanghao"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="维修姓名" prop="weixiuxingming">
            <el-input v-model="ruleForm.weixiuxingming" 
                placeholder="维修姓名" clearable :disabled=" false  ||ro.weixiuxingming"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="修复方式" prop="xiufufangshi">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="修复方式"
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('weixiujilu/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`weixiujilu/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
