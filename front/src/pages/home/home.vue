...
<!-- 特价商品 -->
<div id="animate_listziyuanxinxi" class="lists animate__animated" :style='{"padding":"50px 0 0","margin":"0","position":"relative","background":"#f1f1f1","order":"2"}'>
	
	<div class="title" :style='{"width":"80%","boxShadow":"0 5px 0 #654B3C","margin":"10px auto"}'>
	  <span :style='{"color":"#654B3C","fontSize":"54px"}'>资源信息展示</span>
	</div>
	...
	<div class="list list15 index-pv1" :style='{"padding":"0px","margin":"20px auto 30px","alignItems":"center","display":"flex","width":"80%","justifyContent":"center","height":"auto"}'>
	  <div :style='{"width":"39%","height":"auto"}' class="list left">
		<template v-if="ziyuanxinxiList.length">
	    <template v-for="item,index in ziyuanxinxiList">
		<div v-if="index == 0" @click="toDetail('ziyuanxinxiDetail', item)" :style='{"width":"100%","margin":"10px 0","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-if="preHttp(item.ziyuantupian)" :src="item.ziyuantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-else :src="baseUrl + (item.ziyuantupian?item.ziyuantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源名称:{{item.ziyuanmingcheng}}</div>
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源状态:{{item.ziyuanzhuangtai}}</div>
	      </div>
	    </div>
		</template>
		</template>
		<template v-if="ziyuanxinxiList.length > 1">
		<template v-for="item,index in ziyuanxinxiList">
	    <div v-if="index == 1" @click="toDetail('ziyuanxinxiDetail', item)" :style='{"width":"100%","margin":"10px 0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-if="preHttp(item.ziyuantupian)" :src="item.ziyuantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-else :src="baseUrl + (item.ziyuantupian?item.ziyuantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源名称:{{item.ziyuanmingcheng}}</div>
	  ...
	  <div :style='{"width":"20%","margin":"0 2%","height":"auto"}' class="list center">
		<template v-if="ziyuanxinxiList.length > 2">
			<template v-for="item,index in ziyuanxinxiList">
				<div v-if="index == 2" @click="toDetail('ziyuanxinxiDetail', item)" :style='{"width":"100%","margin":"10px 0","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
					<img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"160px"}' v-if="preHttp(item.ziyuantupian)" :src="item.ziyuantupian.split(',')[0]" alt="" />
					<img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"160px"}' v-else :src="baseUrl + (item.ziyuantupian?item.ziyuantupian.split(',')[0]:'')" alt="" />
					<div class="info">
						<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源名称:{{item.ziyuanmingcheng}}</div>
						<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源状态:{{item.ziyuanzhuangtai}}</div>
					</div>
	    ...
	    <div :style='{"padding":"0","margin":"10px auto","alignItems":"center","borderRadius":"50%","background":"#654B3C","flexDirection":"column","display":"flex","width":"220px","justifyContent":"center","height":"220px"}' class="box2" v-if="ziyuanxinxiList.length > 2">
			<div :style='{"padding":"0 15px","fontSize":"22px","lineHeight":"60px","overflow":"hidden","color":"#fff","height":"60px"}' class="title">{{ziyuanxinxiList[2].ziyuanmingcheng}}</div>
			<div :style='{"padding":"0 15px","overflow":"hidden","color":"#fff","display":"none","fontSize":"16px","lineHeight":"30px","height":"60px"}' class="desc">{{ziyuanxinxiList[2].ziyuanjianjie}}</div>
	    </div>
		<template v-if="ziyuanxinxiList.length > 3">
		<template v-for="item,index in ziyuanxinxiList">
	    <div v-if="index == 3" @click="toDetail('ziyuanxinxiDetail', item)" :style='{"width":"100%","margin":"10px 0","position":"relative","background":"#fff","height":"auto"}' class="box3 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"160px"}' v-if="preHttp(item.ziyuantupian)" :src="item.ziyuantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"160px"}' v-else :src="baseUrl + (item.ziyuantupian?item.ziyuantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源名称:{{item.ziyuanmingcheng}}</div>
	  ...
	  <div :style='{"width":"39%","height":"auto"}' class="list right">
	    <template v-if="ziyuanxinxiList.length > 4">
	    <template v-for="item,index in ziyuanxinxiList">
	    <div v-if="index == 4" @click="toDetail('ziyuanxinxiDetail', item)" :style='{"width":"100%","margin":"10px 0","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-if="preHttp(item.ziyuantupian)" :src="item.ziyuantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-else :src="baseUrl + (item.ziyuantupian?item.ziyuantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源名称:{{item.ziyuanmingcheng}}</div>
		...
		<template v-if="ziyuanxinxiList.length > 5">
		<template v-for="item,index in ziyuanxinxiList">
	    <div v-if="index == 5" @click="toDetail('ziyuanxinxiDetail', item)" :style='{"width":"100%","margin":"10px 0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-if="preHttp(item.ziyuantupian)" :src="item.ziyuantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"180px"}' v-else :src="baseUrl + (item.ziyuantupian?item.ziyuantupian.split(',')[0]:'')" alt="" />
	      <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>资源名称:{{item.ziyuanmingcheng}}</div>
	...
	<div @click="moreBtn('ziyuanxinxi')" :style='{"border":"0","margin":"10px auto","top":"80px","textAlign":"center","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"10%"}'>
		<span :style='{"color":"#9E9E9E","fontSize":"24px"}'>更多</span>
		<i :style='{"color":"#9E9E9E","fontSize":"24px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_listziyuanxinxi',css:'animate__jackInTheBox'},
      ...
      preHttp(str) {
		...
		getList() {
			...
			data['order']= 'desc'
			this.$http.get('ziyuanxinxi/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.ziyuanxinxiList = res.data.data.list;
