		...
		<div class="attr" :style='{"padding":"0","margin":"0","background":"#fff","display":"flex","width":"65%","position":"relative","order":"1"}'>
			...
			<div class="info" :style='{"border":"1px solid #654B3C","padding":"0","margin":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%"}'>
				<div class="item" :style='{"padding":"10px","margin":"0","alignItems":"center","background":"#FF5852","display":"flex","width":"100%","justifyContent":"space-between"}'>
                    ...
                    {{detail.ziyuanleixing}}
                    </div>
				</div>
				<div class="btn" :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","justifyContent":"center","display":"flex"}'>
					<el-button :style='{"border":"1px solid #654b3c","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#654b3c","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('ziyuanleixing','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#654b3c","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('ziyuanleixing','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#654b3c","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('ziyuanleixing','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
